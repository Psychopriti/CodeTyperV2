...
server = 'codetyperserver.database.windows.net'
database = 'codetyperdb'
username  = 'juanadmin'
password  = 'jgmu9683617$'

connection_string = 'Driver={ODBC Driver 18 for SQL Server};Server=tcp:codetyperserver.database.windows.net,1433;Database=codetyperdb;Uid=juanadmin;Pwd=jgmu9683617$;Encrypt=yes;TrustServerCertificate=no;Connection Timeout=30;'
...
def profile():
    ...
    return render_template("profile.html",totalpoints = round(totalpoints,2),user=user, juegos= games_played[0]["juegos"],average = round(average,2), lenguaje_fav =lenguaje_fav, lastgames = last_games, average_points = round(average_points,2))
